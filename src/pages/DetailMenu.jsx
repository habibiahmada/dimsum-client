...
const DetailMenu = () => {
  ...
  return (
    <>
      ...
      <div className="image-container mb-4 mb-md-0" style={{ width: "80%", maxWidth: "500px", height: "auto", overflow: "hidden",animation: "fadeInLeft 1s ease-in-out", justifyContent: "center" }}>
        <img 
